/**
 * Bonaire request-to-book form (Phase 20D).
 * Server-side pricing is authoritative — client total is for review only.
 */
(function () {
  const form = document.getElementById("bon-booking-form");
  if (!form || !window.BON_COMMERCIAL) return;

  const cfg = window.BON_COMMERCIAL;
